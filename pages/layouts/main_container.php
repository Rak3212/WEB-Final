              ...
              <div class="row d-flex align-items-center">
                <div class="col-md-6">
                  <div class="banner-content">
                    ...
                    <a href="index.php?pg=page1" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Product</a>
                  </div>
                </div>
                <div class="col-md-5">
      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            ...
            <div class="btn-right">
              <a href="index.php?pg=page1" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            ...
            <div class="btn-right">
              <a href="index.php?pg=page2" class="btn btn-medium btn-normal text-uppercase">Go to Details</a>
            </div>
          </div>
